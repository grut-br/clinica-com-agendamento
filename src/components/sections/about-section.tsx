...
export function AboutSection() {
  return (
    <section className="relative w-full py-20 sm:py-28 bg-gradient-to-br from-primary to-slate-900 text-white overflow-hidden" id="sobre">
      {/* Detalhes abstratos de fundo para o degradê escuro */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-[10%] left-[20%] h-[300px] w-[300px] rounded-full bg-secondary/10 blur-[80px]" />
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-6 sm:px-8 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          <motion.div
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-white/5 border border-white/10 px-4 py-1.5 text-xs sm:text-sm font-semibold text-secondary mb-4"
          >
          ...
          <motion.p
            ...
            className="mt-4 text-base sm:text-lg text-zinc-350 leading-relaxed font-light"
          >
          ...
          {differentials.map((diff, index) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  {/* Container do Ícone */}
                  <div className="h-10 w-10 rounded-xl bg-primary/5 text-primary flex items-center justify-center mb-5 group-hover:bg-primary group-hover:text-white transition-colors duration-300 border border-primary/5 shrink-0">
                    <IconComponent className="h-5.5 w-5.5 text-secondary group-hover:text-white transition-colors duration-300" />
                  </div>

                  {/* Título do Diferencial */}
                  <h3 className="text-base sm:text-lg font-bold text-primary mb-2 font-sans">
                    {diff.title}
                  </h3>
        ...
        >
          <Link
            href="/#contato"
            className="inline-flex items-center gap-1.5 text-sm sm:text-base font-semibold text-white hover:text-secondary transition-colors"
          >
            Quer saber mais sobre nossa equipe ou agendar uma visita?
            <span className="flex items-center gap-0.5 font-bold underline text-secondary">
              Fale Conosco
