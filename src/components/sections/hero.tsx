...
export function Hero() {
 ...
 <div className="absolute -top-[10%] -right-[10%] h-[350px] sm:h-[450px] w-[350px] sm:w-[450px] rounded-full bg-[#D4AF37]/10 blur-[90px] sm:blur-[110px]"/>
 {/* Glow azul saúde no canto inferior esquerdo */}
 <div className="absolute -bottom-[10%] -left-[10%] h-[400px] sm:h-[500px] w-[400px] sm:w-[500px] rounded-full bg-[#0B1A3A]/5 blur-[100px] sm:blur-[120px]"/>
 ...
 className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/35 bg-[#D4AF37]/10 px-4 py-1.5 text-xs sm:text-sm font-semibold text-[#0B1A3A] backdrop-blur-sm mb-6"
 >
 ...
 className="text-4xl font-extrabold tracking-tight text-[#0B1A3A] sm:text-6xl md:text-7.5xl leading-[1.1]"
 >
 Excelência em Saúde <br className="hidden sm:inline"/>
 e Odontologia <span className="text-[#D4AF37] block sm:inline">no Coração de Pirapemas.</span>
 </motion.h1>
 ...
 <Link
 href="/especialidades"
 className="group inline-flex w-full sm:w-auto items-center justify-center gap-2.5 rounded-full bg-[#D4AF37] hover:bg-[#B5952F] px-8 py-4 text-base font-bold text-[#0B1A3A] transition-all duration-300 shadow-lg shadow-secondary/15 hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
 >
 ...
 className="inline-flex w-full sm:w-auto items-center justify-center gap-2.5 rounded-full border border-slate-200 bg-white hover:bg-slate-50 px-8 py-4 text-base font-bold text-[#0B1A3A] transition-all duration-300 shadow-sm hover:-translate-y-0.5 active:translate-y-0 cursor-pointer"
 >
 ...
 <div className="flex items-center gap-2.5">
 <Star className="h-5 w-5 text-[#D4AF37] fill-[#D4AF37] shrink-0"/>
 ...
 <div className="h-16 w-16 rounded-full bg-white shadow-md border border-slate-100 flex items-center justify-center text-[#D4AF37]">
 <Users className="h-8 w-8"/>
 </div>
 <div>
 <h3 className="text-base font-bold text-[#0B1A3A]">Foto da Equipe Médica</h3>
