...
export function LocationSection() {
 ...
 return (
 <section className="relative w-full py-20 sm:py-28 bg-white text-[#0B1A3A] overflow-hidden"id="localizacao">
 
 {/* Detalhes de background para o fundo claro */}
 <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
 <div className="absolute top-[-10%] left-[-10%] h-[300px] w-[300px] rounded-full bg-[#D4AF37]/5 blur-[80px]"/>
 <div className="absolute bottom-[-10%] right-[-10%] h-[350px] w-[350px] rounded-full bg-[#0B1A3A]/5 blur-[90px]"/>
 ...
 <span className="text-[#D4AF37] bg-clip-text">sorriso e da sua saúde</span>
 </h2>
 ...
 <div className="h-10 w-10 rounded-xl bg-[#0B1A3A]/5 text-[#0B1A3A] flex items-center justify-center border border-[#0B1A3A]/5 shrink-0 mt-0.5">
 <MapPin className="h-5.5 w-5.5 text-[#D4AF37]"/>
 </div>
 <div>
 ...
 <a href={`https://wa.me/${siteConfig.whatsapp}`} target="_blank"rel="noopener noreferrer"className="hover:text-[#0B1A3A] transition-colors font-medium">
 ...
 <li className="flex items-start gap-4">
 <div className="h-10 w-10 rounded-xl bg-[#0B1A3A]/5 text-[#0B1A3A] flex items-center justify-center border border-[#0B1A3A]/5 shrink-0 mt-0.5">
 <InstagramIcon className="h-5.5 w-5.5 text-[#D4AF37]"/>
 </div>
 <div>
 <h4 className="text-sm font-bold text-[#0B1A3A] uppercase tracking-wider">Instagram</h4>
 <a 
 ...
 <Link
 href="/especialidades"
 className="group inline-flex w-full sm:w-auto items-center justify-center gap-2.5 rounded-full bg-[#D4AF37] hover:bg-[#B5952F] px-8 py-4 text-base font-bold text-[#0B1A3A] transition-all duration-300 shadow-xl shadow-[#D4AF37]/10 hover:-translate-y-0.5 active:translate-y-0"
 >
