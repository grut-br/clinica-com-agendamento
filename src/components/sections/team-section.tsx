...
export function TeamSection() {
 ...
 <div className="inline-flex items-center gap-1.5 rounded-full bg-[#0B1A3A]/5 border border-[#0B1A3A]/10 px-4 py-1.5 text-xs sm:text-sm font-semibold text-[#0B1A3A] mb-4">
 <Users className="h-4 w-4 text-[#D4AF37]"/>
 <span>Nossos Especialistas</span>
 </div>
 <h2 className="text-3xl font-extrabold text-[#0B1A3A] sm:text-5xl">
 ...
 <div className="h-28 w-28 rounded-full bg-[#0B1A3A]/5 border-2 border-slate-200 flex items-center justify-center text-[#D4AF37] mb-6 shadow-inner relative overflow-hidden">
 <div className="absolute inset-0 opacity-[0.03] bg-[radial-gradient(#000_1px,transparent_1px)] [background-size:10px_10px]"/>
 <Stethoscope className="h-10 w-10 text-[#D4AF37]"/>
 </div>

 {/* Informações */}
 <h3 className="text-xl font-bold text-[#0B1A3A] font-sans">
 {doctor.name}
 </h3>
 <span className="text-xs text-[#D4AF37] font-bold tracking-wider uppercase mt-1">
 {doctor.role}
 </span>
 <span className="inline-block mt-3 px-3 py-0.5 rounded-full bg-[#0B1A3A]/5 border border-[#0B1A3A]/10 text-2xs font-semibold text-[#0B1A3A]">
 {doctor.registry}
 </span>
